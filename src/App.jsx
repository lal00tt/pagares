...
function App () {
  ...
  const formattedNumber = (
    ...
    const castNumber = parseInt(number)
    return castNumber.toLocaleString('es-MX', { style: 'currency', currency: 'MXN' })
  }
                    ...
                    <div className='w-full flex flex-col gap-y-5'>
                      ...
                      <div className='text-sm'>
                        <p>Debo y Pagaré incondicionalmente por el presente PAGARÉ a la señora <strong> {data.acredor} </strong>,
                          ...
                          indica abajo, la cantidad de <strong>{formattedNumber(data.monto)} ({numberToWords(data.monto)} pesos 00/100 M.N.)</strong> Valor recibido a mi
